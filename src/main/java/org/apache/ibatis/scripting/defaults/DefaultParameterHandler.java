...
public class DefaultParameterHandler implements ParameterHandler {
    ...
    public void setParameters(PreparedStatement ps) {
        ...
        if (parameterMappings != null) {
            ...
            setParametersFor(parameterMappings, ps);

        }
    }// end method setParmeters

    private void setParametersFor(List<ParameterMapping> parameterMappings, PreparedStatement ps) {
        ...
        for (int i = 0; i < parameterMappings.size(); i++) {
            ...
            if (parameterMapping.getMode() != ParameterMode.OUT) {
                ...
                Object value = setParametersForIfs(parameterMapping);
    ...
    }// end method setParametersFor

    private Object setParametersForIfs(ParameterMapping parameterMapping) {
